 ...
 */
class getAssuranceRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AssuranceRepository.php';

        return $container->privates['App\\Repository\\AssuranceRepository'] = new \App\Repository\AssuranceRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
