 ...
 */
class getRhRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RhRepository' shared autowired service.
     *
     * @return \App\Repository\RhRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RhRepository.php';

        return $container->privates['App\\Repository\\RhRepository'] = new \App\Repository\RhRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
