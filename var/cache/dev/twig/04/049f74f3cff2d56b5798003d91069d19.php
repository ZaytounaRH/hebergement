...
class __TwigTemplate_44ff7fa0e755213e796c3d80a9bdccb5 extends Template
{
...
";
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('back_commande_delete', {'id': commande.id}) }}\" onsubmit=\"return confirm('Are you sure you want to delete this item?');\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ commande.id) }}\">
    <button class=\"btn\">Delete</button>
</form>
", "commande/_delete_form.html.twig", "C:\\wamp64\\www\\ZaytounaRHintegff\\templates\\commande\\_delete_form.html.twig");
    }
}
