...
class __TwigTemplate_2e1302c965e21672a41c93575e6e033f extends Template
{
    ...
    <a href=\"";
        // line 19
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_employee_edit", ["employee_id" => CoreExtension::getAttribute($this->env, $this->source, (isset($context["employee"]) || array_key_exists("employee", $context) ? $context["employee"] : (function () { throw new RuntimeError('Variable "employee" does not exist.', 19, $this->source); })()), "employee_id", [], "any", false, false, false, 19)]), "html", null, true);
        yield "\">edit</a>
...
";
    ...
    {
        return array (  126 => 21,  121 => 19,  116 => 17,  108 => 12,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
{% block body %}
    ...
    <a href=\"{{ path('app_employee_edit', {'employee_id': employee.employee_id}) }}\">edit</a>

    {{ include('employee/_delete_form.html.twig') }}
{% endblock %}
", "employee/show.html.twig", "C:\\wamp64\\www\\ZaytounaRHintegff\\templates\\employee\\show.html.twig");
    }
}
