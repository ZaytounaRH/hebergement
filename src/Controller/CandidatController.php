...
final class CandidatController extends AbstractController
{
    ...
    #[Route('/{candidat_id}', name: 'app_candidat_show', methods: ['GET'])]
    ...
    #[Route('/{candidat_id}/edit', name: 'app_candidat_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{candidat_id}', name: 'app_candidat_delete', methods: ['POST'])]
    public function delete(Request $request, Candidat $candidat, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$candidat->getCandidat_id(), $request->getPayload()->getString('_token'))) {
